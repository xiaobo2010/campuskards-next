...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("card_reward_ids", postgresql.JSONB(), server_default="[]", nullable=False),
        sa.Column("special_rules", postgresql.JSONB(), server_default="{}", nullable=False),
        ...
        sa.Column("star_conditions", postgresql.JSONB(), server_default="[]", nullable=False),
        sa.Column("sort_order", sa.Integer(), server_default="0", nullable=False),
        sa.Column("is_active", sa.Boolean(), server_default="true", nullable=False),
        sa.PrimaryKeyConstraint("id"),
